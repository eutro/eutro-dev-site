...
export const Para = mkUtil("Para", "p", "mb-6 last:mb-0");
export const Section = mkUtil("Section", "section", "mb-6 last:mb-0");
export function BlockImg(props: UtilProps<"img">) { return <Block><img {...props}/></Block>; }
export function Caption(props: UtilProps<"i">) { return <Para><i {...props}/></Para>; }
export const Icon = mkUtil("Icon", "span", "inline-flex align-center justify-center");
export const MatIcon = mkUtil("MatIcon", "span", "material-symbols-outlined");
